...
def EdgarIngestion(req):
    ...
    try:
        ...
        config = json.loads(json.dumps(text))['edgar_crawler']
        extractConfig = json.loads(json.dumps(text))['extract_items']
